...
object AnalyseTransactionSpek : Spek({
    describe("AnalyseTransaction") {
        context("when we call AnalyseTransaction is called with the input that does not have accountid") {
        ...
        context("when we call AnalyseTransaction is called with the input(accountId) that has -ive relative balance for the give time period") {
        ...
        context("when we call AnalyseTransaction is called with the input(accountId) that has -ive transaction and positive transaction for the give time period") {
            ...
            val relativeBalance = AnalyseTransaction(expectedOutput).getRelativeBalanceAndNumberOfTransaction(inputData)
            it("returns correct relative balance") {
                assertThat(relativeBalance.relativeBalance, equalTo(BigDecimal("-14.50")))
            }
            it("returns correct number of transaction") {
                assertThat(relativeBalance.numberOfTransaction, equalTo(2))
            }
        ...
        context("when we call AnalyseTransaction is called with the input(accountId) that time period does not exits") {
        ...
        context("when we call AnalyseTransaction is called with the input(accountId) that has 2 transaction and both are reversal") {
